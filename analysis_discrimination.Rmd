...
ggplot(data=data.resp, aes(x=ratio, y=fitted_acc, group=cond, color=cond)) +
      geom_line() +
     # geom_point() +
...
ggplot(data=data.resp.avs.subs.2, aes(x=cond_ord, y=Dots_Counted)) +
  ...
  theme(legend.title=element_blank(), legend.text=element_text(size=12), legend.position=c(0.85,0.85)) +
...
ggsave("figs/dots_counted_diff.pdf", width=5,height=5)
...
ggsave("figs/dots_seen_diff.pdf", width=5,height=5)
